...
{vehicle player removeweapon _x;} forEach _SexyGun;
{vehicle player removeMagazine _x;} forEach _SexyAmmo;

hint "Removed weapons.";
cutText [format["Removed weapons."], "PLAIN DOWN"];
...
{vehicle player removeMagazine _x;} forEach _LVehammo;

hint "Removed op vehicle weapons";
cutText [format["Removed op vehicle weapons"], "PLAIN DOWN"];
*/
...
{vehicle player removeweapon _x;} forEach _GroundGun;
{vehicle player removeMagazine _x;} forEach _GroundAmmo;
{vehicle player removeweapon _x;} forEach _AirGun;
{vehicle player removeMagazine _x;} forEach _AirAmmo;
{vehicle player removeweapon _x;} forEach _WaterGun;
{vehicle player removeMagazine _x;} forEach _WaterAmmo;
*/