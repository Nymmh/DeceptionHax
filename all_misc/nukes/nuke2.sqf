...
_exec = 'if (isServer) then
{
	[] spawn
	{
		...
		{
			nukepos = "old_bike_tk_civ_ep1" cre''+''ate''+''Vehi''+''clelocal position player;
			nukeDONEstar = true;
			...
			{
				_pos = position player;
				_parray = [["\Ca\Data\ParticleEffects\Universal\Universal", 16, 12, 8, 1],"","Billboard",1,4,[0,0,0],[0,0,0],1,0.000001,0,1.4,[0.05,0.05],[[0.1,0.1,0.1,1]],[0,1],0.2,1.2,"","",vehicle player];
			...
			_smoke setParticlePa''+''rams [["\Ca\Data\ParticleEffects\Universal\Universal", 16, 7, 48, 1], "", "Billboard", 1, 25, [0, 0, 0],
				[0, 0, 70], 0, 1.7, 1, 0, [50,20,120],[[1, 1, 1, 0.4],[1, 1, 1, 0.7],[1, 1, 1, 0.7],[1, 1, 1, 0.7],[1, 1, 1, 0.7],[1, 1, 1, 0.7],[1, 1, 1, 0.7],[1, 1, 1, 0]], [0.5, 0.1], 1, 1, "", "", nukepos];
			...
			_Wave setParti''+''cleParams [["\Ca\Data\ParticleEffects\Universal\Universal", 16, 7, 48], "", "Billboard", 1, 20/2, [0, 0, 0],
				[0, 0, 0], 0, 1.5, 1, 0, [50, 100], [[0.1, 0.1, 0.1, 0.5],[0.5, 0.5, 0.5, 0.5], [1, 1, 1, 0.3], [1, 1, 1, 0]], [1,0.5], 0.1, 1, "", "", nukepos];
			...
			for "_i" from 0 to 15 do 
			{
				_smoke setParti''+''cleParams [["\Ca\Data\ParticleEffects\Universal\Universal", 16, 7, 48, 1], "", "Billboard", 1, 25, [0, 0, 0],
					[0, 0, 60+_i], 0, 1.7, 1, 0, [40,15,120],[[1, 1, 1, 0.4],[1, 1, 1, 0.7],[1, 1, 1, 0.7],[1, 1, 1, 0.7],[1, 1, 1, 0.7],[1, 1, 1, 0.7],[1, 1, 1, 0.7],[1, 1, 1, 0]], [0.5, 0.1], 1, 1, "", "", nukepos];
			};
			...
			_smoke setPar''+''ticleParams [["\Ca\Data\ParticleEffects\Universal\Universal", 16, 7, 48, 1], "", "Billboard", 1, 25, [0, 0, 0],
				[0, 0, 30], 0, 1.7, 1, 0, [40,25+10,80],[[1, 1, 1, 0.2],[1, 1, 1, 0.3],[1, 1, 1, 0.3],[1, 1, 1, 0.3],[1, 1, 1, 0.3],[1, 1, 1, 0.3],[1, 1, 1, 0.3],[1, 1, 1, 0]], [0.5, 0.1], 1, 1, "", "", nukepos];
...
sleep 0.1;
} forEach (nearestObjects [position player, ["All"], 50]);
...
sleep 0.1;
} forEach (nearestObjects [position player, ["All"], 150]);
...
sleep 0.1;
} forEach (nearestObjects [position player, ["All"], 200]);
...
} forEach (position player nearEntities [["All"],550]);
*/
