...
if (player distance nukepos < 200000) then {
...
if (player distance nukepos < 400000) then {
...
waitUntil {nukeDONEstar_elektro};
sleep 2;
...
} forEach ([10390,2221,0] nearEntities [["All"],550]);
...
} forEach (nearestObjects [[10390,2221,0], ["house"], 250]);