...
_checkdist = 9000; 	// distance from player to check if it needed vehicle to be added to list
...
_minfuel = 0.01; 	//minimal fuel lvl to get in list (0 (empty tank) to 1 (full tank)).
...
if (selecteditem!= "exitscript") then
{
	...
	if _dred then {cutText [format["Drive your %1",selecteditem],"PLAIN DOWN"];titleFadeOut 2;}
